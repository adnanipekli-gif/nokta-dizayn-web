...
export function CTASection() {
  return (
    <section
      ...
      aria-label="Proje başlatma çağrısı"
    >
      ...
      <div className="section-container relative z-10 text-center">
        <FadeInOnScroll>
          ...
          <h2 className="text-white max-w-3xl mx-auto text-balance mb-8">
            Yeni mağaza, yenileme veya endüstriyel soğutma projeniz için doğru çözümü birlikte
            planlayalım.
          </h2>

          <p className="text-[#E9EEF3]/65 max-w-xl mx-auto mb-10 text-lg leading-relaxed">
            Mühendislik ekibimiz ihtiyacınızı analiz eder, size özel teknik ve bütçe planı hazırlar.
          </p>
