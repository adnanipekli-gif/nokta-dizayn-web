...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://noktadizayn.com.tr/servis-destek' },
};
        ...
        <div className="section-container">
          <FadeInOnScroll>
            <SectionHeading
              ...
              subtitle="Soğutma ekipmanlarınızın en yüksek verimde çalışması için kapsamlı destek hizmetleri."
            />
          </FadeInOnScroll>
            ...
            <FadeInOnScroll key={service.slug}>
              ...
              >
                ...
                <div className={`p-6 lg:p-8 rounded-2xl bg-white border border-[#D9E1EA] ${i % 2 === 1 ? 'lg:order-1' : ''}`}>
                  <p className="eyebrow text-[#11B5FF] mb-4">// HIZLI ERİŞİM</p>
